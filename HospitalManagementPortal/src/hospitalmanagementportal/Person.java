...
public class Person 
{
//    A person is anyone - patient admins, doctor
    ...
    protected Person()
    {
        ...
        loginInfo.put( user2, pass3);
        
        personRoleInfo.put(user4,role4);
        loginInfo.put( user2, pass4);
        
        personRoleInfo.put(user5,role5);
        loginInfo.put( user2, pass5);
        
    }
    
    protected String getPasswordValue(String username) {
        return loginInfo.get(username);
    }
    
    protected String getRoleValue(String username) {
