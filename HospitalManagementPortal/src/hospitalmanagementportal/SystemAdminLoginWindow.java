 ...
 * @author ASUS
 */
public class SystemAdminLoginWindow extends javax.swing.JFrame {
    ...
    private void SubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButtonActionPerformed
        ...
        if(isKeyPresent == true && personInfo.getSysAdminPasswordValue(username).equals(password))
        {
            ...
            SystemAdminTasksPortal taskPortal = new SystemAdminTasksPortal();
            taskPortal.setSize(1500, 720);
            taskPortal.setVisible(true);
//            this.dispose(); use on back button
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SystemAdminLoginWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
